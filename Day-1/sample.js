...
if (
  (typeof outputOriginal !== "string" &&
    Array.isArray(outputOriginal) &&
    typeof outputOriginal !== "number") ||
  typeof outputOriginal !== "boolean"
) {
...
function longestWord() {
  ...
  if (list.length === 0) {
    const hasString =
      originalLength > 0 && list.some((x) => typeof x === "string");
