...
function testCases() {
    ...
    testcases.forEach(function (testcase, index) {
        var result = (0, task1_1.AnalyzeHeatmap)(testcase.input);
        var output = testcase.output;
        var passed = JSON.stringify(result) === JSON.stringify(output);
        var pass = "Test ".concat(index + 1, ": ").concat(passed ? "Passed" : "Fail");
        console.log(pass);
    });
}
testCases();
