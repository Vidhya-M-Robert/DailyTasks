...
function fetchUserPost() {
    return __awaiter(this, arguments, void 0, function (pageNo) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("https://jsonplaceholder.typicode.com/posts?_page=".concat(page, "&_limit=").concat(limit))];
                case 1:
                    response = _a.sent();
